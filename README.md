...
| Charts · comparison tables · deck export · usage analytics | ✅ Working |
...
**Export a deck** — The **Export as Deck** button appears when the answer is an *executive brief* — i.e. the question contains **"brief", "summary", "deck", or "board"**, or spans all sources. Example: *"Give me an executive brief on revenue and customers."* → click **Export as Deck** → **Download .pptx**.
